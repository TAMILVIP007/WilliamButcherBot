...
from wbb import (DEV_USERS, OWNER_ID, DRAGONS, DEMONS, TIGERS, WOLVES,
                          INFOPIC, dispatcher, sw)
from wbb.__main__ import STATS, TOKEN, USER_INFO
import wbb.modules.sql.userinfo_sql as sql
from wbb.modules.disable import DisableAbleCommandHandler
from wbb.modules.sql.global_bans_sql import is_user_gbanned
from wbb.modules.sql.afk_sql import is_afk, check_afk_status
from wbb.modules.sql.users_sql import get_user_num_chats
from wbb.modules.helper_funcs.chat_status import sudo_plus
from wbb.modules.helper_funcs.extraction import extract_user
from wbb import telethn as EmiliaTelethonClient
...
def info(update: Update, context: CallbackContext):
    ...
    if user.id == OWNER_ID:
        text += "\n\nThe Ranking of The Person is Owner of Himawari"
        disaster_level_present = True
    elif user.id in DEV_USERS:
        text += "\n\nThis Person is a Developer of Himawari"
        disaster_level_present = True
    elif user.id in DRAGONS:
        text += "\n\nThis Person is a Sudo-User of Himawari"
        disaster_level_present = True
    elif user.id in DEMONS:
        text += "\n\nThis Person is a Support User of Himawari"
        disaster_level_present = True
    elif user.id in TIGERS:
        text += "\n\nThis User is Immune to all Restrictions over Himawari"
        disaster_level_present = True
